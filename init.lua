...
local web = true
local user = "TechnicallyTotally" -- change if you're using a fork
...
local releaseInfo =
	HttpService:JSONDecode(game:HttpGetAsync("https://api.github.com/repos/" .. user .. "/Hydroxide/releases"))[1]
